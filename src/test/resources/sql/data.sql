...
INSERT INTO post (title, content, created_at, expiration, status, current_no, target_no, address_id,
                  member_id)
VALUES ("test 게시물", "test 목적으로 생성하였음", "2023-02-01 12:00:00", "2023-04-04 23:00:00", 0, 0, 100, 1,
        1);

INSERT INTO post (title, content, created_at, expiration, status, current_no, target_no, address_id,
                  member_id)
VALUES ("검색용", "test 목적으로 생성하였음", "2023-04-04 12:00:00", "2023-04-04 23:00:00", 0, 0, 100, 1, 1);

INSERT INTO post (title, content, created_at, expiration, status, current_no, target_no, address_id,
                  member_id)
VALUES ("test 게시물", "검색용", "2018-02-01 12:00:00", "2023-04-04 23:00:00", 0, 0, 100, 1, 1);
